...
import {
  BASE_URL, SUMMARY_TREND_STATS, WARM_POOL,
  WARM_VUS, WARM_RPS, WARM_DURATION, WARM_START_TIME,
} from "./config.js";
import { download, buildReport, pickRandom } from "./helpers.js";
...
export function handleSummary(data) {
  const report = buildReport("Warm Cache", data);
  return { stdout: report, "k6/results/warm-cache.md": report };
}
